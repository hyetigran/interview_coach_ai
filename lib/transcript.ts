import { z } from 'zod';
export const utteranceSchema = z.object({ id: z.string(), speaker: z.string().nullable(), text: z.string(), startMs: z.number().int().nonnegative(), endMs: z.number().int().positive(), overlap: z.boolean(), corrected: z.boolean().optional() });
