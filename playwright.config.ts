...
export default defineConfig({
  timeout: remoteOrigin ? 90000 : 30000,
  testDir: './e2e', fullyParallel: false, workers: 1,
  use: { baseURL: remoteOrigin ?? 'http://127.0.0.1:3000', trace: 'retain-on-failure' },
  webServer: remoteOrigin ? undefined : { command: 'pnpm exec wrangler dev --ip 127.0.0.1 --port 3000', url: 'http://127.0.0.1:3000', reuseExistingServer: false, timeout: 120000 },
});
